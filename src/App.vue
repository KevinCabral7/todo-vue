...
const getTarefasPendentes =()=>{return estado.tarefas.filter(tarefas => !tarefas.finalizada)}
const getTarefasFinalizadas =()=>{return estado.tarefas.filter(tarefas => tarefas.finalizada)}
...
<form @submit.prevent="cadastraTarefa">
  <div class="row">
    ...
    <div class="col-md-2">
      <select @change="evento => estado.filtro = evento.target.value" name="" id="" class="form-control">
